    ...
    <SettingsContainer>
      ...
      <MainContent>
        ...
        {activeTab === 'general' && (
          <FormContainer>
            <FormHeader>
              <FormTitle>Update your personal information</FormTitle>
              <FormSubtitle>Manage your account details and preferences</FormSubtitle>
            </FormHeader>
        ...
        {activeTab === 'notifications' && (
          <FormContainer>
            <FormHeader>
              <FormTitle>Notification Settings</FormTitle>
              <FormSubtitle>Configure your notification preferences</FormSubtitle>
            </FormHeader>

            <NotificationContainer>
              <NotificationGroup>
                <NotificationItem>
                  <NotificationLabel>All Notifications</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Early Arrival</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Late Arrival</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Early Leaves</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Late Leaves</NotificationLabel>
                  <ToggleSwitch 
              ...
              <NotificationGroup>
                <NotificationItem>
                  <NotificationLabel>Absents Teachers</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Daily Reports</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Weekly Reports</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Monthly Reports</NotificationLabel>
                  <ToggleSwitch 
                ...
                <NotificationItem>
                  <NotificationLabel>Yearly Reports</NotificationLabel>
                  <ToggleSwitch 
            ...
            <TestSection>
              <TestSectionTitle>Test Notifications</TestSectionTitle>
