...
const TeacherSignin: React.FC<TeacherSigninProps> = () => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/auth/teacher/signin', {
        method: 'POST',
        headers: {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/auth/teacher/send-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/auth/teacher/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
