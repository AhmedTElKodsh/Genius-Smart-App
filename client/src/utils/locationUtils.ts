...
export const SCHOOL_LOCATION: SchoolLocation = {
  ...
  latitude: 29.999378235298405, // Updated coordinates
  longitude: 31.420123584961413,
  allowedRadius: 500 // 500 meters radius for more accurate location verification
};
