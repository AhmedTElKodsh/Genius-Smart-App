...
const Content = styled.div<{ isDarkMode: boolean; isRTL?: boolean }>`
  padding: 24px;
...
const MetricCard = styled.div<{ isDarkMode: boolean; isRTL?: boolean }>`
...
const MetricValue = styled.div<{ isDarkMode: boolean; color?: string; isRTL?: boolean }>`
  font-size: 24px;
  font-weight: 700;
...
const MetricLabel = styled.div<{ isDarkMode: boolean; isRTL?: boolean }>`
  font-size: 12px;
