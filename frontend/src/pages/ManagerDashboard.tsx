  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        const url = `${API_BASE_URL}/dashboard/overview?${params.toString()}`;
    ...
    const fetchNewChartsData = async () => {
      ...
      try {
        ...
        const [checkInsResponse, absencesResponse, immediateRequestsResponse] = await Promise.all([
          fetch(`${API_BASE_URL}/dashboard/today-checkins?${queryString}`),
          fetch(`${API_BASE_URL}/dashboard/today-absences?${queryString}`),
          fetch(`${API_BASE_URL}/dashboard/immediate-requests?${queryString}`)
        ]);
