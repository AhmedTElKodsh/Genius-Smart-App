...
const enTranslations = {
  ...
  'reports.fullTime': 'Full-time',
  'reports.partTime': 'Part-time',
  ...
  // Validation Messages
        ...
        'validation.pleaseFixErrors': 'Please fix the errors below',
        'errors.unauthorized': 'Unauthorized: Invalid token. Please login again.',
        'errors.updateFailed': 'Failed to update teacher',
...
const arTranslations = {
  ...
  // Validation Messages
        ...
        'validation.pleaseFixErrors': 'يرجى تصحيح الأخطاء أدناه',
        'errors.unauthorized': 'غير مصرح: رمز غير صالح. يرجى تسجيل الدخول مرة أخرى.',
        'errors.updateFailed': 'فشل تحديث بيانات المعلم',
        'errors.networkError': 'خطأ في الشبكة. يرجى المحاولة مرة أخرى.',
